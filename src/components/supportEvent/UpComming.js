...
import { fundraisRequest, blockUser, unblockUser, getRequestByEmail } from "../../api";
...
function AllUser() {
  ...
  const handleAllUser = async (pageNo) => {
    try {
      const result = await fundraisRequest(pageNo);
      console.log(result.totalPages);
      console.log(result.requestedCall);
      setUserData(result.requestedCall);
          ...
          <div id="content">
                ...
                >
                  <ul className="navbar-nav text-black">
                    ...
                    >
                    All fundrais Request{" "}
                    </h4>
                  </ul>

                  <form class="form-inline my-2 my-lg-0" style={{ marginLeft: "45%" }}>
                    <div>
                      <input
                                ...
                                >
                                  ...
                                  >
                                    <Link
                                      ...
                                      to={`/support-event-detail/${row.email}`}
                                    >
                                      {row.email}
                                    </Link>
                                  </td>
                                  ...
                                  >
                                    {" "}
                                    +91 {row.phoneNumber? row.phoneNumber:"**********"}
                                  </td>
                                  {/* <td className="pt-3">
                                    {row.blocked ? (
                                      <button
